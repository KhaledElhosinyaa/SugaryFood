...
st.set_page_config(page_title="Gharbiya Sugar Food Detection",
                   page_icon="🍔")

#### SideBar ####

st.sidebar.title("What's Our Purpose ?")
st.sidebar.write("""
To help people with sugar problems
""")


#### Main Body ####

st.title("Gharbiya Sugar Food Detection")
